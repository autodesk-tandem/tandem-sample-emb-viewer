...
function event_DtMsgWsReconnected(e) { dumpEventInfo('DT_MSG_WS_RECONNECTED', e); }
...
export function addEventListeners() {
    ...
    dtApp.addEventListener(Autodesk.Tandem.DT_MSG_WS_RECONNECTED, event_DtMsgWsReconnected);
...
export function removeEventListeners() {
    ...
    dtApp.removeEventListener(Autodesk.Tandem.DT_MSG_WS_RECONNECTED, event_DtMsgWsReconnected);
