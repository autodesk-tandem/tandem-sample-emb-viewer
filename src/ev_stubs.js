...
function event_DtCurrentViewChangedEvent(e) {
  dumpEventInfo("DT_CURRENT_VIEW_CHANGED_EVENT", e);
}

function event_DtFacilityViewsChangedEvent(e) {
  dumpEventInfo("DT_FACILITY_VIEWS_CHANGED_EVENT", e);
}

function event_DtTelemetryChangedEvent(e) {
  dumpEventInfo("DT_TELEMETRY_CHANGED_EVENT", e);
}

function event_DtTelemetryTickEvent(e) {
  dumpEventInfo("DT_TELEMETRY_TICK_EVENT", e);
}

function event_DtFacilityUserChangedEvent(e) {
  dumpEventInfo("DT_FACILITY_USER_CHANGED_EVENT", e);
}
